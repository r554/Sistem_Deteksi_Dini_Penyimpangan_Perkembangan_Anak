            ...
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="<?php echo base_url('Homepage') ?>">
                        <span class="dropdown-item dropdown-header">Sistem Pakar</span>
                    </a>
                    ...
                    <a href="<?php echo base_url('Profil/tampil_profil/' . $id_user) ?>" class="dropdown-item">
                        Edit Profil
                        <span class="float-right text-muted text-sm"></span>
                    </a>
                    <div class="dropdown-divider"></div>
                    <a href="<?php echo base_url('Profil/edit_ubahpw/' . $id_user) ?>" class="dropdown-item">Ubah
                        Password
                        <span class="float-right text-muted text-sm"></span>
                    </a>
                    <div class="dropdown-divider"></div>
                    <a href="<?php echo base_url('Login/logout') ?>" class="dropdown-item">Log Out
                        <span class="float-right text-muted text-sm"></span>
                    </a>
